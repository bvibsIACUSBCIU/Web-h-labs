...
import { TechCase, MediaCategory, AirdropItem, CourseCategory, IntelItem, WhaleAlert, BountyTask, TrendingTopic, SmartMoneyFlow, KOLBenefit, MarketTicker, SectorData, CexFlow, DevActivity, StablecoinMetric, TwitterProfile, KOLPeer, StrategicPartner, MediaPartner } from './types';
...
export const bountyTasks: BountyTask[] = [
  { id: 'b1', title: "Binance New User Registration Campaign", project: "Binance", reward: "$50 + 20% Rebate", type: "CEX", slots: 500, filled: 120, deadline: "5d", difficulty: 'Easy' },
  { id: 'b2', title: "Nexus Chain Validator Guide Thread", project: "Nexus Chain", reward: "$200 NEX", type: "Content", slots: 10, filled: 8, deadline: "24h", difficulty: 'Medium' },
  { id: 'b3', title: "ZkSync Era Daily Transaction Task", project: "ZkSync", reward: "Potential Airdrop", type: "OnChain", slots: 1000, filled: 850, deadline: "Ongoing", difficulty: 'Easy' },
  { id: 'b4', title: "LayerZero Cross-chain Bridge Volume", project: "LayerZero", reward: "Airdrop Points", type: "Airdrop", slots: 9999, filled: 5400, deadline: "Ongoing", difficulty: 'Medium' },
  { id: 'b5', title: "Bybit Launchpool Staking Promotion", project: "Bybit", reward: "$100 USDT", type: "CEX", slots: 50, filled: 50, deadline: "Ended", difficulty: 'Easy' },
];
...
export const mockTwitterUser: TwitterProfile = {
  handle: "@CryptoWhale_H",
  followers: "128.5K",
  blueVFollowers: "2,450",
  impressions24h: "1.2M",
  engagementRate: "4.8%",
};

export const kolPeers: KOLPeer[] = [
  { id: 'k1', name: "DeFi Wizard", handle: "@defi_wiz", tags: ["DeFi", "Research"], followers: "45k", isMutual: false },
  { id: 'k2', name: "NFT Hunter", handle: "@nft_hunt", tags: ["NFT", "Alpha"], followers: "82k", isMutual: true },
  { id: 'k3', name: "Chain Detective", handle: "@chain_det", tags: ["Security", "OnChain"], followers: "120k", isMutual: false },
  { id: 'k4', name: "Airdrop King", handle: "@airdrop_k", tags: ["Airdrop", "Guide"], followers: "210k", isMutual: true },
];
...
// --- 硬核技术支持 (Tech Support) ---
export const techSupportCategories = [
  {
    id: 'infrastructure',
    title_zh: '基础设施',
    title_en: 'Infrastructure',
    desc_zh: '定制公链、钱包、SwapX、预测市场等一站式技术支持。',
    desc_en: 'Customized blockchain, wallet, SwapX, prediction market all-in-one technical support.',
    icon: 'database',
    color: 'blue',
    items_zh: ['定制 L1/L2 公链', 'MPC 钱包方案', 'SwapX 聚合器', '去中心化预测市场'],
    items_en: ['Custom L1/L2 Chain', 'MPC Wallet Solution', 'SwapX Aggregator', 'Decentralized Prediction Market']
  },
  {
    id: 'rwa',
    title_zh: 'RWA 赛道',
    title_en: 'RWA Track',
    desc_zh: '现实资产上链，合规架构搭建与技术实现。',
    desc_en: 'Real-world asset tokenization, compliance architecture and technical implementation.',
    icon: 'building',
    color: 'emerald',
    items_zh: ['资产代币化', '合规法律架构', '链上保管/信托', '房地产上链'],
    items_en: ['Asset Tokenization', 'Compliance Framework', 'On-Chain Custody/Trust', 'Real Estate Tokenization']
  },
  {
    id: 'meme',
    title_zh: '流量与 Meme',
    title_en: 'Traffic & Meme',
    desc_zh: '病毒式营销、Meme 文化孵化、海量流量注入。',
    desc_en: 'Viral marketing, Meme culture incubation, massive traffic injection.',
    icon: 'flame',
    color: 'orange',
    items_zh: ['Meme 孵化器', '病毒式传播', '精准流量注入', '社区运营 (CTO)'],
    items_en: ['Meme Incubator', 'Viral Propagation', 'Precision Traffic', 'Community Ops (CTO)']
  }
];

// --- H Media 影响力矩阵 (Influence Matrix) ---
export const mediaInfluenceCategories = [
  {
    id: 'twitter',
    title_zh: '推特 (X) 深度运营',
    title_en: 'Twitter (X) Deep Operations',
    desc_zh: '人格化建模，每日精编优质资产 + 增长黑客手段。',
    desc_en: 'Personalized modeling, daily curated premium content + growth hacking tactics.',
    icon: 'twitter',
    color: 'sky'
  },
  {
    id: 'engagement',
    title_zh: '高频交互 (Space/AMA)',
    title_en: 'High-Frequency Engagement (Space/AMA)',
    desc_zh: '策划、邀约、主持、会后总结一站式闭环。',
    desc_en: 'Planning, invitations, hosting, and post-event summary - full-cycle service.',
    icon: 'mic',
    color: 'purple'
  },
  {
    id: 'roadshow',
    title_zh: '全球高端路演',
    title_en: 'Global Premium Roadshows',
    desc_zh: '迪拜、新加坡、香港等核心枢纽路演沙龙、黑会与投资圈会定制。',
    desc_en: 'Dubai, Singapore, Hong Kong - core hub roadshow salons, exclusive gatherings and investor events.',
    icon: 'globe',
    color: 'amber'
  }
];
