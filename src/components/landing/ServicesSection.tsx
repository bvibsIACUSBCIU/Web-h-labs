        ...
        <div className="py-24 bg-slate-50 border-t border-slate-100 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="text-center mb-16">
                    <h3 className="text-orange-600 font-bold text-sm uppercase tracking-widest mb-2">{t('services_section.subtitle')}</h3>
                    <h2 className="text-3xl md:text-4xl font-bold text-slate-900">{t('services_section.title')}</h2>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white border border-slate-200 p-8 rounded-xl hover:border-blue-500/40 hover:shadow-xl transition-all duration-300 group">
                        ...
                        <h3 className="text-2xl font-bold text-slate-900 mb-4">{t('services_section.tech.title')}</h3>
                        <p className="text-slate-500 mb-6 leading-relaxed text-sm">
                            {t('services_section.tech.desc')}
                        </p>
                        <div className="flex flex-wrap gap-2">
                            {getTags('services_section.tech.tags').map((tag, i) => (
                    ...
                    <div className="bg-white border border-slate-200 p-8 rounded-xl hover:border-purple-500/40 hover:shadow-xl transition-all duration-300 group">
                        ...
                        <h3 className="text-2xl font-bold text-slate-900 mb-4">{t('services_section.brand.title')}</h3>
                        <p className="text-slate-500 mb-6 leading-relaxed text-sm">
                            {t('services_section.brand.desc')}
                        </p>
                        <div className="flex flex-wrap gap-2">
                            {getTags('services_section.brand.tags').map((tag, i) => (
                                <span key={i} className="text-xs font-bold px-3 py-1.5 rounded bg-slate-50 text-slate-600 border border-slate-200">
                                    {tag}
                                </span>
                            ))}
                    ...
                    <div className="bg-white border border-slate-200 p-8 rounded-xl hover:border-orange-500/40 hover:shadow-xl transition-all duration-300 group">
                        ...
                        <h3 className="text-2xl font-bold text-slate-900 mb-4">{t('services_section.media.title')}</h3>
                        <p className="text-slate-500 mb-6 leading-relaxed text-sm">
                            {t('services_section.media.desc')}
                        </p>
                        <div className="flex flex-wrap gap-2">
                            {getTags('services_section.media.tags').map((tag, i) => (
                                <span key={i} className="text-xs font-bold px-3 py-1.5 rounded bg-slate-50 text-slate-600 border border-slate-200">
                                    {tag}
                                </span>
                            ))}
