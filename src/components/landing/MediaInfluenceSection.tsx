        ...
        <div className="py-24 bg-slate-50 border-t border-slate-100 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-2">{t('media_influence.title')}</h2>
                    <p className="text-slate-500 text-sm max-w-2xl mx-auto">{t('media_influence.subtitle')}</p>
                </div>
